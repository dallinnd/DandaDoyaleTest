...
function showHome() {
    ...
    app.innerHTML = `<div class="p-6 h-full flex flex-col animate-fadeIn">
        ...
        <div class="text-sm font-black uppercase tracking-wider opacity-60 mb-2 px-1">Online Game</div>

        <div class="flex gap-3 mb-6">
            <button onclick="openHostModeSelect()" class="flex-1 py-4 bg-white text-slate-900 rounded-2xl font-black text-md uppercase tracking-wider shadow-lg">Host</button>
            <button onclick="joinExistingGame()" class="flex-1 py-4 bg-slate-800 text-white rounded-2xl font-black text-md uppercase tracking-wider shadow-lg">Join</button>
        </div>
        <div class="text-sm font-black uppercase tracking-wider opacity-60 mb-2 px-1">or Start a Local Game</div>
        <button onclick="openNewGameModal()" class="w-full bg-green-600 py-4 rounded-2xl font-black text-xl text-white shadow-xl active:scale-95 transition-all">START LOCAL GAME</button>
