...
function showHome() {
    ...
    app.innerHTML = `<div class="p-6 h-full flex flex-col animate-fadeIn">
        ...
        <div class="text-xs font-black uppercase tracking-wider opacity-60 mb-2 px-1">or Start a Local Game</div>
        <button onclick="openNewGameModal()" class="w-full bg-green-600 py-5 rounded-3xl font-black text-xl text-white shadow-xl active:scale-95 transition-all">START LOCAL GAME</button>
